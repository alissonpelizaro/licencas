              ...
              <form role="form" action="<?php echo base_url(); ?>login/execLogin" method="POST">
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control pl-3" required name="login" placeholder="Usuário" maxlength="30" type="text">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control pl-3" required name="password" placeholder="Senha" maxlength="30" type="password">
                  </div>
                </div>
